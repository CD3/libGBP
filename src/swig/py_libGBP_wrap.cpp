...
/*-----------------------------------------------
              @(target):= _py_libGBP.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__py_libGBP

#else
#  define SWIG_init    init_py_libGBP

#endif
#define SWIG_name    "_py_libGBP"
...
SWIGINTERN PyObject *_wrap_new_GaussianBeam(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GaussianBeam *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_GaussianBeam")) SWIG_fail;
  result = (GaussianBeam *)new GaussianBeam();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_GaussianBeam, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_GaussianBeam(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GaussianBeam *arg1 = (GaussianBeam *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_GaussianBeam",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_GaussianBeam, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_GaussianBeam" "', argument " "1"" of type '" "GaussianBeam *""'"); 
  }
  arg1 = reinterpret_cast< GaussianBeam * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *GaussianBeam_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_GaussianBeam, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
