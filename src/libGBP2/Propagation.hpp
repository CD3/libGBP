...
CircularGaussianLaserBeam propagate_beam_through_system(const CircularGaussianLaserBeam& a_beam, const OpticalSystem<U1>& a_system, const quantity<U2>& a_position)
{
